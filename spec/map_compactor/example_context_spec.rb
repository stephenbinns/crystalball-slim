...
describe Crystalball::MapCompactor::ExampleContext do
  ...
  describe "#include?" do
    ...
    specify do
      ...
      expect(subject).to_not include "file_spec.rb[1:1]"
      expect(subject).to_not include "file_spec.rb[2:2]"
      expect(subject).to_not include "file_spec.rb[1:21]"
      expect(subject).to_not include "file_spec.rb[1]"
      expect(subject).to_not include "file_spec.rb"
    end
  end
